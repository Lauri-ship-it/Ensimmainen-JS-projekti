function Parilli()
{
  var karvo = parseInt(document.getElementById('parLuku').value);
  var jono = "<p>";
...
function chekaaKirjain()
{
  var annettuSana = document.getElementById('osana').value;
  var vastaus = 'ei ole';
